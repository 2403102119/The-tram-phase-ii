...
//					RouteBusLineItem busline = busStep.getBusLines().get(0);
    ...
    public static void calculateLength(final String str,final Activity activity, final int distance, double sLat, double sLng, double dLat, double dLng,final TextView juli){
        ...
        distanceSearch.setDistanceSearchListener(new DistanceSearch.OnDistanceSearchListener() {
            ...
            public void onDistanceSearched(DistanceResult distanceResult, int i) {
                ...
                if (i==1000&&distanceResult.getDistanceResults().size()>0){
                    ...
                    MUIToast.show(activity,"没有计算出驾车距离,已使用直线距离");
                    length =distance;
                }
                juli.setText(str+AMapUtil.getFriendlyLength(length));
            }
        });
        LatLonPoint start = new LatLonPoint(sLat, sLng);
