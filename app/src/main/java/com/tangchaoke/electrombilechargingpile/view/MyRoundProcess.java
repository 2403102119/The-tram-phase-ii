...
public class MyRoundProcess extends View {
    ...
    private void initAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            ...
            textColor = a.getColor(R.styleable.MyRoundProcess_textColors, getResources().getColor(android.R.color.holo_blue_dark));
            textSize = a.getDimension(R.styleable.MyRoundProcess_textSize, 22f);
            mStrokeWidth = a.getDimension(R.styleable.MyRoundProcess_circleWidth, 40f);
