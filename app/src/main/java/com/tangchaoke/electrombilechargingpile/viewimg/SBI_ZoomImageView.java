...
public class SBI_ZoomImageView extends ImageView implements View.OnTouchListener,
    ...
    private class MultiGestureDetector extends GestureDetector.SimpleOnGestureListener implements
            ...
            if (photoTapListener != null) {
                ...
                if (null != displayRect) {
                    ...
                    if (displayRect.contains(x, y)) {
                        ...
                        photoTapListener.onPhotoTap(SBI_ZoomImageView.this, xResult, yResult);
                        return true;
                    }
                }
            }
            if (viewTapListener != null) {
                viewTapListener.onViewTap(SBI_ZoomImageView.this, event.getX(), event.getY());
            }
        ...
        public void onLongPress(MotionEvent e) {
            if (longClickListener != null) {
                longClickListener.onLongClick(SBI_ZoomImageView.this);
            }
        }
    }
    ...
    public SBI_ZoomImageView(Context context) {
        this(context, null);
    }

    public SBI_ZoomImageView(Context context, AttributeSet attr) {
        this(context, attr, 0);
    }

    public SBI_ZoomImageView(Context context, AttributeSet attr, int defStyle) {
    ...
    private class AnimatedZoomRunnable implements Runnable {
        ...
        public void run() {
            ...
            if (((deltaScale > 1f) && (currentScale < targetZoom))
                ...
                // again
                postOnAnimation(SBI_ZoomImageView.this, this);
