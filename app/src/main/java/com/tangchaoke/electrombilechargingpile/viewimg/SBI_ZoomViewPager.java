 ...
 */
public class SBI_ZoomViewPager extends ViewPager {

    public SBI_ZoomViewPager(Context context) {
        super(context);
    }

    public SBI_ZoomViewPager(final Context context, final AttributeSet attrs) {
        super(context, attrs);
    }
